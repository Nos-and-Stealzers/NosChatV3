...
// The one display face in the app — used sparingly (wordmark, empty
// states, dialog titles) to give the utility-heavy mono/sans grid some
// warmth, in keeping with the app's "signal in the dark" identity.
