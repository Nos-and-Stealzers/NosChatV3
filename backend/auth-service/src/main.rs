...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/friends/block", post(friends::block_user))
        .route("/friends/block/{user_id}", axum::routing::delete(friends::unblock_user))
        ...
        .route(
            "/guilds/{guild_id}/channels/{channel_id}/messages/{message_id}/attachment",
